 ...
 */
@CommandDefinition(name="diff", description="Saves current provisioned configuration changes into a feature pack.", activator = NoStateCommandActivator.class)
...
//        parameters.put("gav", coord);
        ...
        try {
            getManager(session).exportConfigurationChanges(targetFile, ArtifactCoords.newGav(coord), parameters);
